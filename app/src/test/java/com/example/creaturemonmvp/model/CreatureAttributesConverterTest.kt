...
import com.example.creaturemonmvp.model.room.CreatureAttributesConverter
...
class CreatureAttributesConverterTest {
    ...
    fun testFromCreatureAttributes() {
        ...
        val expectedValue = "10,0,7"

        assertEquals(expectedValue, attributesConverter.fromCreatureAttributes(attributes))
    }
